package uy.com.innobit.rem.persistence.datamodel.dashboardemo;
...
public abstract class DummyDataGenerator {
    ...
    static Collection<DashboardNotification> randomNotifications() {
        ...
        n1.setId(1);
        n1.setFirstName("Contrato:");
        n1.setLastName(" propiedad 1");
        n1.setAction("");
        n1.setPrettyTime("vence 15/11/2015");
        n1.setContent("");

        DashboardNotification n2 = new DashboardNotification();
        n2.setId(2);
        n2.setFirstName("Expensas:");
        n2.setLastName(" propiedad xx");
        n2.setAction("");
        n2.setPrettyTime("vence 20/11/2015");
        n2.setContent("");
