package uy.com.innobit.rem.presentation.view.transactions;
...
import uy.com.innobit.rem.presentation.component.MovieDetailsWindow;
import uy.com.innobit.rem.presentation.event.DashboardEvent.BrowserResizeEvent;
import uy.com.innobit.rem.presentation.event.DashboardEvent.TransactionReportEvent;
...
public final class TransactionsView extends VerticalLayout implements View {
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(RemUI
        ...
        table.setColumnFooter(
                "price",
                "$"
                        + DECIMALFORMAT.format(RemUI.getDataProvider()
                                .getTotalSum()));
            ...
            if (action == report) {
                ...
                if (item != null) {
                    Long movieId = (Long) item.getItemProperty("movieId")
                            .getValue();
                    MovieDetailsWindow.open(RemUI.getDataProvider()
