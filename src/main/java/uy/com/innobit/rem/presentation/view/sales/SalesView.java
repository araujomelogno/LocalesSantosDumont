package uy.com.innobit.rem.presentation.view.sales;
...
import uy.com.innobit.rem.persistence.datamodel.dashboardemo.MovieRevenue;
...
public class SalesView extends VerticalLayout implements View {
    ...
    public SalesView() {
        ...
        List<Movie> subList = new ArrayList<Movie>(RemUI
    ...
    private void initMovieSelect() {
        Collection<Movie> movies = RemUI.getDataProvider().getMovies();
    ...
    private void addDataSet(final Movie movie) {
        ...
        Collection<MovieRevenue> dailyRevenue = RemUI.getDataProvider()
