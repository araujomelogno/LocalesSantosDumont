...
import uy.com.innobit.rem.persistence.datamodel.dashboardemo.DashboardNotification;
import uy.com.innobit.rem.presentation.RemUI;
import uy.com.innobit.rem.presentation.component.SparklineChart;
import uy.com.innobit.rem.presentation.component.TopGrossingMoviesChart;
...
public final class DashboardView extends Panel implements View, DashboardEditListener {
	...
	private Component buildSparklines() {
		...
		SparklineChart s = new SparklineChart("Propiedades", "133");
		sparks.addComponent(s);

		s = new SparklineChart("Contratos activos", "41");
		sparks.addComponent(s);

		s = new SparklineChart("Propietarios", "100");
		sparks.addComponent(s);

		s = new SparklineChart("Facturado anual", "US$100.522.220");
		sparks.addComponent(s);
	...
	// @Override
	// public void buttonClick(final ClickEvent event) {
	// getUI().addWindow(new DashboardEdit(DashboardView.this,
	// titleLabel.getValue()));
	// }
	// });
	// return result;
	...
	private Component buildNotes() {
		...
		notes.setValue(
				"Pendientes:\n· Cerrar contrato local XXX\n· Ingresar gastos contrato xxx\n· Revisar inventarios de propiedad xxx\n·");
		notes.setSizeFull();
	...
	private void openNotificationsPopup(final ClickEvent event) {
		...
		Collection<DashboardNotification> notifications = RemUI.getDataProvider().getNotifications();
	...
	public static final class NotificationsButton extends Button {
		...
		public void updateNotificationsCount(final NotificationsCountUpdatedEvent event) {
			setUnreadCount(RemUI.getDataProvider().getUnreadNotificationsCount());
		}
