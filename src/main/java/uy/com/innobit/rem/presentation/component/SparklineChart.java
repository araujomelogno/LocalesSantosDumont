...
public class SparklineChart extends VerticalLayout {
	...
	public SparklineChart(final String name, String value) {
		setSizeUndefined();
		addStyleName("spark");
		setDefaultComponentAlignment(Alignment.TOP_CENTER);

		// int[] values =
		// DummyDataGenerator.randomSparklineValues(howManyPoints, min, max);
		...
		// Label highLow = new Label("High <b>" +
		// java.util.Collections.max(vals)
		// + "</b> &nbsp;&nbsp;&nbsp; Low <b>"
